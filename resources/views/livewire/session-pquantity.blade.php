<div class="container">
    ...
    @if ($message)
        <div class="alert alert-success alert-dismissible fade show mt-2 fs-6 " role="alert">{{ $message }}
                                ...
                                <div class="col-10 p-0">
                                    <div class="row  d-flex justify-content-between h-100">
                                        <div class="col-7 px-2 ps-3">
                                            <span class="d-block fw-bold w-100 text-wrap fs-6">{{ $details['name'] }}</span>
