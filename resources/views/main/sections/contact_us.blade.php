...
@section('content')
    <section class="py-3 mb-4 py-md-5">
        <div class="container">
            <div class="row gy-3 gy-md-4 gy-lg-0 align-items-lg-center">
                <div class="col-12 col-lg-6 order-1 ">
                    <img class="img-fluid rounded" loading="lazy" src="{{ asset('images/banners/contact-img-1.jpg') }}"
                        alt="Get in touch">
                </div>
                <div class="col-12 col-lg-6 order-0 ">
                    <div class="row justify-content-xl-center">
                        <div class="col-12 col-xl-11">
                            ...
                            <p class="lead fs-4 text-secondary mb-5">We're always on the lookout to work with new clients.
                                If you're interested in working with us, please get in touch in one of the following ways.
                            </p>
        ...
        <div class="container">
            <div class="row justify-content-md-center">
                <div class="col-12 col-md-10 col-lg-8 col-xl-7 col-xxl-6">
                    <h2 class="display-5 mb-4 mb-md-5 text-center">We're always on the lookout to work with new clients.
                    </h2>
        ...
        <div class="container">
            <div class="row gy-3 gy-md-4 gy-lg-0 align-items-xl-center">
                <div class="col-12 col-lg-6 ">
                    <img class="img-fluid rounded" loading="lazy" src="{{ asset('images/banners/contact-img-2.jpg') }}"
                        alt="Get in Touch">
                </div>
                <div class="col-12 col-lg-6">
                    <div class="row justify-content-xl-center">
